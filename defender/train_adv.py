...
def train_with_challenge(ember_dir: str, dike_dir: str, challenge_goodware: str, 
...
if __name__ == "__main__":
    ...
    parser.add_argument('--ember-dir', type=str, default='/home/gamdhameet/ember_dataset/ember')
    parser.add_argument('--dike-dir', type=str, default='/home/gamdhameet/DikeDataset-main/files')
    parser.add_argument('--challenge-goodware', type=str, default='/home/gamdhameet/challenge/challenge_ds/goodware')
    parser.add_argument('--challenge-malware', type=str, default='/home/gamdhameet/challenge/challenge_ds/malware')
